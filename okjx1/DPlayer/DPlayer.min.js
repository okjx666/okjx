! function (e, t) {
    ...
    return function (e) {
        ...
        function (e, t, n) {
        window.a="82aa5873c6a36d7de68f5bc36e87f130";
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
        ...
        function (e, t, n) {
            ...
            var i = {
                "zh-cn": {
                    ...
                    "Show danmaku": "显示弹幕",
                    "Video load failed": "视频加载失败，请切换清晰度重试",
        ...
        function (e, t, n) {
            ...
            console.log("\n %c 云海科技 %c http://api.ymcx.shop \n\n", "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;"), t.default = o.default
        }
    ]).default
});
function ckflv(tvid,vid,bid,tim,jcb){
var suffix = '/jp/dash?tvid=' + tvid + '&vid=' + vid + '&bid=' + bid + '&abid=200&src=02020031010000000000&uid=&ut=&ori=h5&ps=0&messageId=' + tim + '&ost=0&preIdAll=&locale=zh_cn&dfp=&k_tag=1&k_ft1=755914244096&k_ft5=1&k_err_retries=0&k_uid=1daf95973553c0bb1a0fa8769fdddb2e&pt=0&lid=&cf=&ct=&ve=ed59ca95b84471655391d459d872999b&qd_v=2&tm=' + tim + '&qdy=a&qds=0';
var vf = cmd5x(suffix + '&callback=' + jcb);
